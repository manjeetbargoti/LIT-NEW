        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-6 pl-4">
                ...
                <ul class="p-0">
                    ...
                    <li> <b>Duration</b>: <span id="budg_dur">{{ $data->duration }}</span> <span
                            id="budg_tp">{{ $data->time_period }}</span> </li>
                ...
                <div class="btnbx mt-2">
                    ...
                    <a href="{{ url('/initiative-programs/'.$data->slug) }}" class="btn btn-primary text-uppercase">
                        Learn More</a>
                    @elseif(!empty($data->service_name))
                    <a href="{{ url('/digital-service/add-to-cart/'.$data->id) }}"
                        class="btn btn-primary text-uppercase"> Add to Impact Box</a>
                    <a href="{{ url('/digital-programs/'.$data->slug) }}" class="btn btn-primary text-uppercase"> Learn
                        More</a>
                    @endif
                </div>
            </div>
